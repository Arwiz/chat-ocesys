...
const page = (props: any) => {
    ...
    const [participant, setParticipant] = React.useState<any[] | undefined>(
        undefined
    );
    ...
    return (
        <>
            <div>
                <h6 className="text-lg font-bold dark:text-white text-center mt-10">
                    PokerRoom
                </h6>
                ...
                <div className="items-center justify-center ">
                    <div className="flex justify-evenly">
                        <p className="mr-10 text-gray-500 dark:text-gray-400">
                            Story for Poker
                        </p>
                        <Dropdown
                            label={selectedStory?.name || ' Select Stories'}
                            dismissOnClick={true}
                        >
                            {stories.map((story) => (
                                <Dropdown.Item
                            ...
                            {participant?.map((user) => (
                                <div className="flex-1 flex-wrap gap-2">
                                    <Avatar
                                        ...
                                        rounded
                                    />
                                    <p className="text-2xl font-semibold text-gray-900 dark:text-white text-center m-2">
                                        {user?.vote === 0 ? 'N/A' : user?.vote}
                                    </p>
                                    <p className="text-sx font-semibold text-gray-900 dark:text-white text-center">
                                        {user?.email}
                                    </p>
                                </div>
                            ))}
